...
class RawGAT_ST(nn.Module):
    ...
    def forward(self, x, Freq_aug=False):
        ...
        # To fuse both spectral (out1) and temporal (out2) graphs using element-wise addition  (graph combination)
        out_gat=torch.add(out1,out2)  #(#bs,feat_dim,#node) -->  #[#bs, 32, 12]
