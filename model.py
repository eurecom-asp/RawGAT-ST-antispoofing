...
from start_config import set_random_seed
from RawGAT_ST_github_code import RawGAT_ST
...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/medias/speech/projects/tak/tools/RawNet_anti_spoofing/', help='Change with path to user\'s LA database protocols directory address')
    ...
    parser.add_argument('--features', type=str, default='RawNet2_new')
    ...
    dir_yaml = os.path.splitext('model_config_RawGAT_ST_github')[0] + '.yaml'
    ...
    dev_set = data_utils_LA_RawGAT.ASVDataset(database_path=args.database_path,protocols_path=args.protocols_path,is_train=False, is_logical=is_logical,
    ...
    # Training Dataloader
    train_set = data_utils_LA_RawGAT.ASVDataset(database_path=args.database_path,protocols_path=args.protocols_path,is_train=True, is_logical=is_logical, transform=transforms,
